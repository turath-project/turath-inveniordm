...
# -*- coding: utf-8 -*-
#
# Script to generate a new API token and update RDM_API_TOKEN in .env file
#
...
# Configuration - using admin@turath.com 
...
echo -e "\n==== Complete! ===="
echo "A new API token has been generated and saved to your .env file as RDM_API_TOKEN."
